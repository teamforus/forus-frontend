module.exports = {
    ...
    financial_dashboard_transaction: {
        ...
        tooltips: {
            pending_iban_from: "Vanaf deze bankrekening wordt de transactie uitbetaald. Deze kan nog wijzigen tot dat de betaling is verstuurd naar de bank, in de meeste gevallen gebeurt dit dagelijks automatisch om 09:00 's ochtends.",
            pending_iban_to: "Naar deze bankrekening wordt de transactie uitbetaald. Deze kan nog wijzigen tot dat de betaling is verstuurd naar de bank, in de meeste gevallen gebeurt dit dagelijks automatisch om 09:00 's ochtends.",
        }
    },
