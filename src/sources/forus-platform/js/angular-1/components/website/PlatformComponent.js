let PlatformComponent = function() {
    ...
    $('.play_btn_link').on('click', function(e) {
        ...
        var video = $(target).closest('.tab-pane').find('.tab_video video');
    ...
    $('.tab_video video').hover(function toggleControls() {
    ...
    $(document).ready(function(){
        ...
        $( 'a[data-toggle="tab"]' ).on('shown.bs.tab', function(e) {
            ...
            video = $(tab_block).find('.tab_video video');
...
module.exports = {
    ...
    templateUrl: 'assets/tpl/pages/website/platform.html'
};