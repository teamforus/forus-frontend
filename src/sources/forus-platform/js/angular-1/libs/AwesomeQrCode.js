    ...
    Drawing.prototype.draw = function(oQRCode) {
        ...
        if (gifBackground === undefined) {
            ...
            if (this._bindElement !== undefined) {
                try {
                    var el = isElement(this._bindElement) ? this._bindElement : document.querySelector(this._bindElement);
                    if (el.nodeName === 'IMG') {
...
module.exports = new AwesomeQRCode();