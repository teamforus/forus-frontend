    ...
    home: {
        ...
        faq: {
            ...
            nijmegen: {
                ...
                six: "U kunt uw voucher altijd terugvinden door in te loggen op de webshop. Ga naar 'Log in' rechts bovenaan en log in met uw e-mailadres. Vervolgens kunt u de voucher uitprinten, naar uw e-mail sturen of altijd bij de hand hebben door gebruikt te maken de Me-app op uw telefoon.",
                faq_seven: "Hoe kan ik zien hoeveel budget ik nog over heb?",
                seven: "Na elke betaling wordt er een e-mail toegestuurd met het huidige budget, U kunt daarnaast uw budget inzien door in te loggen op de webshop of door gebruik te maken van de Me-app op uw telefoon.",
                ...
                faq_nine: "Moet het budget in een keer besteed worden?",
                nine: "Nee, u hoeft het budget niet in een keer te besteden.",
                ...
                twelve: "Het budget kan alleen uitgegeven worden bij de organisaties die zich hebben aangemeld voor de Meedoen-regeling en op de webshop staan. U kunt wel een organisatie vragen deel te nemen. Een organisatie kan zich het hele jaar door aanmelden.",
