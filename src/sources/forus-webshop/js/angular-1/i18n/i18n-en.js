    ...
    home: {
        ...
        faq: {
            ...
            nijmegen: {
                ...
                faq_two: "Hoe kan ik mij aanmelden voor een activiteit of cursus",
                two: "Klik links bovenaan op 'Aanbiedingen' en maak uw keuze. Om een aanbieding te kopen dient u ingelogd te zijn.",
                faq_three: "Hoe kan ik inloggen op de webshop?",
                three: "Klik rechts bovenaan op 'Inloggen'. Kies voor 'log in via e-mail'. Vul het e-mailadres in die u ook tijdens de activatie hebt gebruikt en klik op 'Versturen'. Open uw e-mail en klik op de link die u heeft ontvangen om in te loggen. ",
                faq_four: "Bij welke organisaties kan ik mij aanmelden voor een activiteit of cursus?",
                four: "U kunt een overzicht van alle organisaties terugvinden op de webshop. Ga naar 'Overzicht van alle organisaties.",
                faq_five: "Ik ben mijn voucher kwijt. Wat moet ik doen?",
                five: "U kunt uw voucher altijd terugvinden door in te loggen op de webshop. Ga naar 'Log in' rechts bovenaan en log in met uw e-mailadres. Vervolgens kunt u de voucher uitprinten, naar uw e-mail sturen of altijd bij de hand hebben door gebruikt te maken de Me-app op uw telefoon.",
                faq_six: "Hoe kan ik zien hoeveel budget ik nog over heb?",
                six: "Na elke betaling wordt er een e-mail toegestuurd met het huidige budget, U kunt daarnaast uw budget inzien door in te loggen op de webshop of door gebruik te maken van de Me-app op uw telefoon.",
                faq_seven: "Kan ik een aanmelding voor een cursus of activiteit annuleren?",
                seven: "In de webshop kunt u een activiteit of cursus niet meer anulleren om het bedrag voor iets anders te gebruiken. U kunt wel bij de organisatie vragen of u een activiteit of cursus kunt ruilen voor iets anders.",
                faq_eight: "Moet het budget in een keer besteed worden?",
                eight: "Nee, u hoeft het budget niet in een keer te besteden.",
                faq_nine: "Hoe lang is de Meedoen-voucher geldig?",
                nine: "De voucher geldig tot en met 31 december 2019. De cursus of activiteit mag doorlopen in 2020.",
                faq_ten: "Kan ik de Meedoen-voucher omruilen voor contant geld?",
                ten: "Nee, de waarde van de voucher krijgt u niet in contact geld uitbetaald.",
                faq_eleven: "Kan ik iets doen bij een andere organisatie die niet op de webshop staat?",
                eleven: "Het budget kan alleen uitgegeven worden bij de organisaties die zich hebben aangemeld voor de Meedoen-regeling en op de webshop staan. U kunt wel een organisatie vragen deel te nemen. Een organisatie kan zich het hele jaar door aanmelden.",
                faq_twelve: "Hoe kom ik in aanmerking voor de Meedoen-regeling?",
                twelve: "U doet een aanvraag bij de gemeente Nijmegen. De voorwaarden om mee te doen en deel te nemen doet u hier: https://www.nijmegen.nl/diensten/uitkering-schulden-en-laag-inkomen/meedoen-regeling/'",
