    ...
    home: {
        ...
        faq: {
            ...
            nijmegen: {
                ...
                faq_two: "Hoe kan ik inloggen op de webshop?",
                two: "Dit kan op meerdere manieren, het makkelijkste is per e-mail. Klik rechts bovenaan op 'Inloggen'. Kies voor 'log in via e-mail'. Vul het e-mailadres in die u ook tijdens de activatie hebt gebruikt en klik op 'Versturen'. Open uw e-mail en klik op de link die u heeft ontvangen om in te loggen.",
                ...
                faq_four: "Ik ben mijn voucher kwijt. Wat moet ik doen?",
                four: "U kan uw voucher altijd terugvinden door in te loggen op de webshop. Vervolgens kunt u de voucher uitprinten en naar uw e-mail toesturen of altijd bij hand hebben door gebruik te maken van de Me-app.",
                faq_five: "Hoe kan ik zien hoeveel budget ik nog over heb?",
                five: "Na elke betaling wordt er een e-mail toegestuurd met het huidige budget, daarnaast kan je het budget inzien door in te loggen op de webshop of door gebruik te maken van de Me-app.",
                faq_six: "Kan ik mijn aankoop ook annuleren?",
                six: "Een aankoop is definitief. Een terugbetaling is niet mogelijk",
                faq_seven: "Moet het budget in een keer besteed worden?",
