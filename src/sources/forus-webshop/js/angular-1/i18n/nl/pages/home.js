module.exports = {
    ...
    faq: {
        ...
        noordoostpolder: {
            ...
            one: "Klik bovenaan op 'Start aanvraag'. Vul uw e-mailadres en de activatiecode in die u per brief heeft ontvangen. Klik vervolgens op 'Versturen'. Uw profiel is aangemaakt en uw Meedoen-voucher is geactiveerd!",
            ...
            fourteen: "Log in op de webshop en klik op 'Aanbiedingen'. Kies vervolgens het aanbod die u wilt en klik op 'Koop'. Kies vervolgens een Meedoenpakket-tegoed om de aanbod mee te kopen. Het bedrag van het aanbod wordt van uw Meedoenpakket-voucher afgehaald en er wordt een nieuwe voucher aangemaakt. De nieuwe voucher kan alleen gebruikt worden voor de aanbieding die u heeft gekocht.",
        },
        winterswijk: {
