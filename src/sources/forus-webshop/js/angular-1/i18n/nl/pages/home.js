module.exports = {
    ...
    faq: {
        ...
        nine: "Nee, het tegoed krijg je niet in contant geld uitbetaald.",
        faq_ten: "Kan ik iets kopen bij een andere aanbieder die niet op de webshop staat?",
        ten: "Nee, het tegoed kunt u alleen uitgeven bij organisaties die op de webshop staan.",
        ...
        thirteen: "Nee, het tegoed is strikt persoonlijk. Je mag het tegoed niet aan iemand anders geven. Maakt iemand anders wel gebruik van jouw tegoed dan wordt je eigen bedrag lager.",
        faq_fourteen: "Ik zie aanbod op de webshop staan, hoe kan ik een product of dienst kopen?",
        fourteen: "Log in op de webshop en klik op 'Aanbod'. Kies vervolgens het aanbod die je wilt en klik op 'Reserveer'. Kies vervolgens {{fund}}-tegoed om de product of dienst mee te reserveren. Het bedrag van het aanbod wordt van je {{fund}}-tegoed afgehaald en er wordt een nieuwe tegoed aangemaakt. Het nieuwe tegoed kan alleen gebruikt worden voor het aanbod dat je hebt gekocht.",
        nijmegen: {
        ...
        Westerkwartier: {
            ...
            one: "Klik bovenaan op 'Start aanvraag'. Vul uw e-mailadres en log in met DigiD. Uw profiel is aangemaakt en uw tegoed is geactiveerd!",
            ...
            faq_eight: "Hoe lang is mijn tegoed geldig?",
            eight: "Door in te loggen op de webshop kunt u bij ‘Mijn tegoeden’ uw tegoed inzien. Klik bij het tegoed op ‘Open’. Op deze pagina staat ook de geldigheid vermeld.",   
            faq_twelve: "Hoe kom ik in aanmerking voor het Kindpakket?",
            twelve: "Als u denkt recht te hebben op het Kindpakket, neem dan contact op met de gemeente via telefoonnummer: 14 0594. De gemeente bekijkt dan of je voldoet aan de voorwaarden.",
        },
        noordoostpolder: {
        ...
        berkelland: {
            ...
            faq_fourteen: "Ik zie aanbod op de webshop staan, hoe kan ik een product of dienst kopen?",
            fourteen: "Log in op de webshop en klik op 'Aanbod'. Kies vervolgens het aanbod die u wilt en klik op 'Koop'. Kies vervolgens een Kindregeling-tegoed om het aanbod mee te kopen. Het bedrag van het aanbod wordt van uw Kindregeling-tegoed afgehaald en er wordt een reservering aangemaakt.",
            faq_fifteen: "Welke organisaties kunnen mij ook ondersteuning bieden?",
            fifteen: "De kledingbank kan u ondersteunen u door het verstrekken van kleding, schoenen en textiel. Tweemaal per jaar kunt u bij hen terecht, hiervoor heeft u een doorverwijzing nodig. De informatie hierover vindt u op <a target='_blank' href='http://www.kledingbankwinterswijk.nl/home.aspx'>http://www.kledingbankwinterswijk.nl/home.aspx</a><br/><br/>" + 
                "Stichting leergeld kan u ondersteunen op het vlak van schoolkosten of kosten voor sport, wanneer deze kosten niet vergoed worden door Sociale Dienst Oost Achterhoek, meer informatie hierover vindt u op <a target='_blank' href='https://leergeldoostachterhoek.nl/welkom'>https://leergeldoostachterhoek.nl/welkom</a><br/><br/>" +
                "Bij de speelgoedbank kunt u speelgoed lenen, hiervoor heeft u een doorverwijzing nodig. Meer informatie vindt u op <a target='_blank' href='http://www.speelgoedbankoostachterhoek.nl/speelgoed-doneren/ophalen/'>http://www.speelgoedbankoostachterhoek.nl/speelgoed-doneren/ophalen</a><br/><br/>" +
    ...
    guide: {
        ...
        westerkwartier: {
            ...
            two: "Klik op de knop ‘Start aanvraag’ om uw aanvraag te starten. Gebruik uw eigen e-mailadres en log in met DigiD. U ontvangt een e-mailbericht over de status van de aanvraag.",
