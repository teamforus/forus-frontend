module.exports = {
    ...
    faq: {
        ...
        four: "Je kan je voucher altijd terugvinden door in te loggen op de webshop, het tegoed kun je uitprinten, naar je e-mail toesturen of zelfs altijd bij hand hebben door gebruik te maken van de Me app.",
        ...
        noordoostpolder: {
            ...
            eight: "Door in te loggen op de webshop kunt u uw tegoed inzien. Op de pagina van de tegoed staat ook de geldigheid vermeld.",
            nine: "Nee, de waarde van de tegoed krijg u niet in contact geld uitbetaald.",
            ...
            fourteen: "Log in op de webshop en klik op 'Aanbod'. Kies vervolgens het aanbod die u wilt en klik op 'Koop'. Kies vervolgens een Meedoenpakket-tegoed om de aanbod mee te kopen. Het bedrag van het aanbod wordt van uw Meedoenpakket-tegoed afgehaald en er wordt een nieuw aanbod tegoed aangemaakt.. Het nieuwe tegoed kan alleen gebruikt worden voor het aanbod die u heeft gekocht.",
        },
        winterswijk: {
