...
export enum DashboardRoutes {
    ...
    ORGANIZATION_IDENTITY_PROVIDERS = 'organization-identity-providers',
    ORGANIZATION_IDENTITY_PROVIDER_CONNECTION = 'organization-identity-provider-connection',
    ...
    FUND_PRODUCT_LIMITS = 'fund-product-limits',
    PREVALIDATION_REQUEST = 'prevalidation-request',
    ...
    SECURITY_LINKED_ACCOUNTS = 'security-linked-accounts',
    REDIRECT = 'redirect',
    HOME = 'home',
    NOT_FOUND = 'not-found',
    THROW = 'throw',
